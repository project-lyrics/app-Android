    ...
    Dialog(onDismissRequest = {}) {
        Column(
            modifier = modifier.width(280.dp)
                .background(color = feelinColors.modal, shape = RoundedCornerShape(size = 12.dp)),
            ...
            Row(
                ...
                isDismissButtonEnable.takeIf { it }?.let {
                    Box(
                        modifier = Modifier
                            .weight(1f)
                            .height(52.dp)
                            .clickable(onClick = onDismissButtonClick::invoke),
                ...
                Box(
                    modifier = Modifier
                        .weight(1f)
                        .height(52.dp)
                        .clickable(onClick = onConfirmButtonClick::invoke),
                    contentAlignment = Alignment.Center
                ) {
                    Text(
